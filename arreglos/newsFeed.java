...
public static void main(String[] args){
    String[] robotArticles = {"Oil news", "Innovaive Motors", "Humans Extreminate or Not", "Orgnic Eye Implants", "Path Finding in an Unknown World"};
    ...
    System.out.println("The top article is " + robotTimes.getTopArticle() + " and the array length is: " + robotArticles);
